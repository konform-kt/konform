...
class ValidationSubTypingCompilerTest {
    ...
    fun compileErrorOnInvalidSubtyping() {
        ...
        result.messages shouldContain "Initializer type mismatch: expected 'Validation<Number>', " +
            "actual 'Validation<Int>'"
    }
    ...
    fun compileErrorOnInvalidRun() {
        ...
        result.exitCode shouldBe KotlinCompilation.ExitCode.COMPILATION_ERROR
        result.messages shouldContain "Argument type mismatch: actual type is 'Validation<Int>', " +
            "but 'Validation<Number>' was expected"
    }
}
